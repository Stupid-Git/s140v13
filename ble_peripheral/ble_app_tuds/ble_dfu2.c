...
uint32_t ble_dfu_init(ble_dfu_t * p_dfu, ble_dfu_init_t * p_dfu_init)
{
    ...
    const ble_uuid128_t base_uuid128 =
    {
#if 0 //OLD D123 -> D124
        {
            //0x23, 0xD1, 0xBC, 0xEA, 0x5F, 0x78, 0x23, 0x15, //karel
            0x24, 0xD1, 0xBC, 0xEA, 0x5F, 0x78, 0x23, 0x15, //karel
...
#else
        {
          //0x24, 0xD1, 0xBC, 0xEA, 0x5F, 0x78, 0x23, 0x15, //karel
          //0xDE, 0xEF, 0x12, 0x12, 0x00, 0x00, 0x00, 0x00
            0xAA, 0xC1, 0x6C, 0xCA, 0x3A, 0xD1, 0x4C, 0x86,
            0xF2, 0x48, 0x7D, 0x76, 0x00, 0x00, 0x00, 0x00
        }
#endif
    };
